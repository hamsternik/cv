...
\newcommand{\contacts}[1]{
    \begin{center}\color{contactgray}{\small#1}\end{center}
}
...
\contacts{
    \url{hamsternik9@gmail.com} \hspace{1cm} \url{hamsterniknotes.com}
}

\vspace{-12px}

\contacts{
    \href{https://www.linkedin.com/in/khomitsevych/}{LinkedIn} \hspace{0.5cm} 
    \href{http://github.com/hamsternik}{GitHub} \hspace{0.5cm} 
    \href{https://stackoverflow.com/users/3527499/hamsternik}{Stack Overflow}
}

\vspace*{8px}

\noindent iOS software developer with 5+ years of engineering in plenty of complex projects and distributed 
...
\noindent \textbf{\href{https://www.life360.com}{Life360 Inc.}}, 2020/01--2022/04. 
