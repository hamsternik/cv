...
\begin{itemize}[label=-]
    ...
    \item Developed Family Safety Assist (FSA) feature allowing access, e.g. roadside assistance in US and Canada. 
...
\begin{itemize}[label=-]
    \setlength\itemsep{0em}
    \item Worked on iOS applications for manufactored FDA cleared device for remote nonstress tests for pregnant. 
